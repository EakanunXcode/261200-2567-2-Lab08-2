...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        Thread tuanoi1 = new Thread(new Turtle1());
        Thread tuanoi2 = new Thread(new Turtle2());
        Thread tuanoi3 = new Thread(new Turtle3());
        Thread tuanoi4 = new Thread(new Turtle4());
        Thread tuanoi5 = new Thread(new Turtle5());
    ...
    static class Turtle1 implements Runnable {
        public void run() {
    ...
    static class Turtle2 implements Runnable {
        public void run() {
            Turtle bob = new Turtle();
    ...
    static class Turtle3 implements Runnable {
        public void run() {
            Turtle bob = new Turtle();
    ...
    static class Turtle4 implements Runnable {
        public void run() {
            Turtle bob = new Turtle();
    ...
    static class Turtle5 implements Runnable {
        public void run() {
            Turtle bob = new Turtle();
            bob.penColor(Color.yellow);
            bob.speed(10);
